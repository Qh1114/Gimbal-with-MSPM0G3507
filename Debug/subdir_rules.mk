...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/TI/ccs2041/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O0 -I"C:/Users/Qh/Desktop/Gimbal/App" -I"C:/Users/Qh/Desktop/Gimbal" -I"C:/Users/Qh/Desktop/Gimbal/Debug" -I"C:/TI/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"C:/Users/Qh/Desktop/Gimbal/Middle" -I"C:/Users/Qh/Desktop/Gimbal/HardWare" -I"C:/TI/mspm0_sdk_2_10_00_04/source" -I"C:/Users/Qh/Desktop/Gimbal/Test" -gdwarf-3 -Wall -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-1986052266: ../main.syscfg
	@echo 'SysConfig - building file: "$<"'
	"C:/TI/sysconfig_1.26.2/sysconfig_cli.bat" -s "C:/TI/mspm0_sdk_2_10_00_04/.metadata/product.json" --script "C:/Users/Qh/Desktop/Gimbal/main.syscfg" -o "." --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-1986052266 ../main.syscfg
device.opt: build-1986052266
device.cmd.genlibs: build-1986052266
ti_msp_dl_config.c: build-1986052266
ti_msp_dl_config.h: build-1986052266
Event.dot: build-1986052266
